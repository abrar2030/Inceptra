...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelectorAll(".contact-card").forEach((card) => {
    ...
    if (title.includes("github") && socialLinks["github"]) {
      ...
      link.href =
        socialLinks["facebook"] || "https://www.facebook.com/abrar2O3O";
    }
  });
  ...
  document
    .querySelectorAll(".project-card, .education-item, .contact-card")
    .forEach((element) => {
      element.classList.add("fade-in");
      observer.observe(element);
    });

  // Skills Section Functionality: Removed old tab and progress bar logic.
  // The new skills section is a static grid and does not require JavaScript.
...
// Mobile Menu Functionality - Codetra Style
